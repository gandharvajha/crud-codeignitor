      ...
      <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group"> 
                <label>Name</label>
                <input type="text" name="name" value="<?php set_value('name', $user['name']); ?>" class="form-control"/>
                <?php  echo form_error('name'); ?>
            </div>
            <div class="form-group">
                <label>Email</label>
                <input type="text" name="email" value="<?php set_value('email',$user['email']); ?>" class="form-control"/>
